...
time-invariant envelopes and OUR/B3 algorithms (see cfg/*). Use this script
as a convenience wrapper that tags the run directory and prints the summary.

Usage examples:
  # Soft TI envelope (OUR)
  uv run python scripts/exp_tinmpc.py --cfg cfg/smoke_test_our.yaml --tag our_demo

  # Hard TI envelope (B3)
  uv run python scripts/exp_tinmpc.py --cfg cfg/smoke_test_b3.yaml --tag b3_demo
"""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    p.add_argument("--cfg", type=Path, default=Path("cfg/smoke_test_our.yaml"), help="Scenario YAML config")
